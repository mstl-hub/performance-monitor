...
//#define DMA1_CHANNEL1_MEMORY_BASE_ADDR   0 NOT USED
...
#define DMA1_CHANNEL3_BUFFER_SIZE   64
//#define DMA1_CHANNEL3_MEMORY_BASE_ADDR   0 NOT USED
...
/* Private defines -------------------------------------------------------------*/
#define reed_switch_PIN    GPIO_PINS_0
#define reed_switch_GPIO_PORT    GPIOD
#define nfc_field_detection_PIN    GPIO_PINS_1
#define nfc_field_detection_GPIO_PORT    GPIOD
#define battery_voltage_PIN    GPIO_PINS_0
